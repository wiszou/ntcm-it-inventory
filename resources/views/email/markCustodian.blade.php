...
<body>
	...
	<p>Good day!</p>
	<p>We are pleased to inform you that your Custodian Form {{ $custodian1->custodian_id }} has been closed. <br />Below are the details for your reference:</p>

	<table style="margin-bottom:1px;">
		<tr>
			<td> <span style="font-weight: bold;">Form ID: </span>{{ $custodian1->custodian_id }}</td>
		</tr>
		<tr>
			<td> <span style="font-weight: bold;">Date Created: </span>{{ $custodian1->start_date }}</td>
		</tr>
		<tr>
			<td> <span style="font-weight: bold;">Date Ended: </span>{{ $custodian1->end_date }}</td>
		</tr>
		<tr>
			<td> <span style="font-weight: bold;">Purpose: </span>{{ $custodian1->description }}</td>
		</tr>
		<tr>
